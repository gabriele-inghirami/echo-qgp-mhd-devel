# This scripts makes comparison plots between the distributions of
# of the x components of the velocity on the x-y plane for two different simulations
# Set variables
echo_qgp_dir="../../"
...
do for [i=iniframe:endframe] {
   ...
   outfile = sprintf("vx".'%04.0f.png',i)
   set output outfile
