# This scripts makes comparison plots between the energy density
# distributions of the x-y plane of two different simulations
# Set variables
echo_qgp_dir="../../"
dir1=echo_qgp_dir."outr0001/postproc/readx/"
dir2=echo_qgp_dir."outr0001_NO_magnetic_field/postproc/readx/"
title1="MHD"
title2="HD"
...
stmin1=system("head -1 " . dir1.var1."_stats" . " | awk '{print $1}'")
stmax1=system("head -1 " . dir1.var1."_stats" . " | awk '{print $2}'")
stmin2=system("head -1 " . dir2.var2."_stats" . " | awk '{print $1}'")
stmax2=system("head -1 " . dir2.var2."_stats" . " | awk '{print $2}'")
...
do for [i=iniframe:endframe] {
   ...
   outfile = sprintf("endens".'%04.0f.png',i)
   set output outfile
   set multiplot layout 1,2 title keytitle
   set title title1
   set cblabel "En. dens. [GeV/fm^{3}]"
